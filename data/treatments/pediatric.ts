...
export const pediatricTreatments: TreatmentContent[] = [
  {
    ...
    benefits: [
      '유치 충치의 조기 발견과 관리로 영구치 발육에 도움이 됩니다.',
      '아이의 협조도에 맞춘 단계적 접근으로 불안감을 줄입니다.',
      '진행 속도가 빠른 유치 충치를 적절한 시기에 치료할 수 있습니다.',
      '씹는 기능과 발음 발달에 필요한 유치 기능을 유지하는 데 도움이 됩니다.',
      '정기 검진을 통해 구강 건강 습관을 함께 형성할 수 있습니다.',
    ],
    faq: [
      {
  ...
  },
  {
    ...
    benefits: [
      '치과에 대한 불안과 공포심을 줄이는 데 도움이 됩니다.',
      '의식이 유지된 상태에서 진정 효과를 기대할 수 있습니다.',
      '흡입 중단 후 빠르게 회복되어 일상 복귀가 가능합니다.',
      '치료 경험을 긍정적으로 만들어 이후 내원에도 도움이 됩니다.',
      '필요한 치료를 보다 원활하게 진행하는 데 도움이 됩니다.',
    ],
    faq: [
      {
